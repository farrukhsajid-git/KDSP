      ...
      <div className="bg-blue-600 text-white py-4 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="font-bold text-lg">SAVE THE DATE</span>
          </div>
          <p className="text-sm md:text-base">
            <strong>Saturday, May 16, 2026</strong> — KDSP Virginia Chapter Launch
          </p>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-20 pt-64 lg:pt-0">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-md mx-auto relative">
            ...
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="text-2xl font-bold text-gray-900">May 16, 2026</span>
            </div>
            <div className="flex items-start justify-center gap-2 text-gray-600">
              ...
              <div className="text-sm">
                ...
                <p className="mt-1 font-medium">Time: To be Announced</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-10">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8 text-center">
            <p className="text-blue-800 font-medium">
              RSVP below to confirm your attendance for the May 16th event!
            </p>
          </div>
